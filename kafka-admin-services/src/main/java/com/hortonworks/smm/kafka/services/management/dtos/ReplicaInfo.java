...
public class ReplicaInfo {
    ...
    private ReplicaInfo(long size, long offsetLag, boolean isFuture) {
        this.size = size;
    ...
    public boolean equals(Object o) {
        ...
        return size == that.size &&
                offsetLag == that.offsetLag &&
                isFuture == that.isFuture;
    }

    @Override
    public int hashCode() {
        return Objects.hash(size, offsetLag, isFuture);
    }
