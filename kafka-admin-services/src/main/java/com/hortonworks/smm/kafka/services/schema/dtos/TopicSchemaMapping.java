...
public class TopicSchemaMapping {
    ...
    public TopicSchemaMapping(String keySchemaName, String valueSchemaName) {
        Preconditions.checkNotNull(valueSchemaName, "schema value name can't be null");
    ...
    public boolean equals(Object o) {
        ...
        TopicSchemaMapping that = (TopicSchemaMapping) o;

        if (getKeySchemaName() != null ? !getKeySchemaName().equals(that.getKeySchemaName()) : that.getKeySchemaName() != null) return false;
        return getValueSchemaName() != null ? getValueSchemaName().equals(that.getValueSchemaName()) : that.getValueSchemaName() == null;
    }

    @Override
    public int hashCode() {
        int result = getKeySchemaName() != null ? getKeySchemaName().hashCode() : 0;
