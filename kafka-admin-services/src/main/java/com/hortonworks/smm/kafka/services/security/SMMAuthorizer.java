...
public interface SMMAuthorizer {
     ...
     */
    void init(AuthorizerConfiguration config);
     ...
     */
    boolean authorize(AuthenticationContext ctx, ResourceType resourceType, String resourceName, Permission permission);
}
