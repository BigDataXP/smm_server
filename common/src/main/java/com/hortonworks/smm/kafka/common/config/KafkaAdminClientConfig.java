...
public class KafkaAdminClientConfig {
    ...
    public KafkaAdminClientConfig(String bootstrapServerString, Map<String, Object> config) {
        ...
        adminProperties.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServerString);
        Map<String, Object> propertiesMap = (Map<String, Object>) config.computeIfAbsent("properties", key -> Collections.EMPTY_MAP);
        adminProperties.putAll(propertiesMap);

        this.config = Collections.unmodifiableMap(adminProperties);
    }
    ...
    public Integer getRequestTimeoutMs() {
        return (Integer) config.get(AdminClientConfig.REQUEST_TIMEOUT_MS_CONFIG);
    }
    ...
    public boolean equals(Object o) {
        ...
        KafkaAdminClientConfig that = (KafkaAdminClientConfig) o;
